...
lines(dvals, colMeans(blad.dvh[which(wide.data$Age65_numeric == 1),]), lwd = 3, col = "blue")
lines(dvals, colMeans(blad.dvh[which(wide.data$Age65_numeric == 0),]), lwd = 3, col = "orange")
...
lines(dvals, colMeans(skin.dvh[which(wide.data$Age65_numeric == 1),]), lwd = 3, col = "blue")
lines(dvals, colMeans(skin.dvh[which(wide.data$Age65_numeric == 0),]), lwd = 3, col = "orange")
legend("topright", col = color_labs, name_labs, lty = rep(1, 2), lwd = rep(2, 2))
par(op)
dev.off()
...
lines(dvals, colMeans(blad.dvh[which(wide.data$`GU Toxicity` == 1),]), lwd = 3, col = "blue")
lines(dvals, colMeans(blad.dvh[which(wide.data$`GU Toxicity` == 0),]), lwd = 3, col = "orange")
points(d.star_bladder, q_bladder, col = "red", pch = 19)
legend("topright", col = color_labs, name_labs, lty = rep(1, 2), lwd = rep(2, 2))
par(op)
dev.off()
...
lines(dvals, colMeans(skin.dvh[which(wide.data$`GI Toxicity` == 1),]), lwd = 3, col = "blue")
lines(dvals, colMeans(skin.dvh[which(wide.data$`GI Toxicity` == 0),]), lwd = 3, col = "orange")
points(d.star_skin, q_skin, col = "red", pch = 19)
legend("topright", col = color_labs, name_labs, lty = rep(1, 2), lwd = rep(2, 2))
par(op)
dev.off()
